...
- Bot no longer permanently disconnects when Discord drops the websocket during
  ...
  reconnect with Oban-style polynomial backoff. [#25](https://github.com/hpopp/kurpo-bot/pull/25)
...
- Typing indicator more accurately reflects message length. [#23](https://github.com/hpopp/kurpo-bot/pull/23)

## [0.6.6] - 2025-06-22

### Changed

- Various internal refactoring and testing. [#21](https://github.com/hpopp/kurpo-bot/pull/21)
